# BAG One-year Roadmap / 百舸一年开发路线图

- Brand / 品牌：**百舸 / BAG — Build Across Games**
- Period / 周期：**2026-08 — 2027-07**
- Target / 年度目标：**v0.8 Public Beta**
- Website roadmap / 网站完整路线图：<https://syurli.github.io/BAG/roadmap.html>
...
| M1 | 2–3 | Data Loop / 数据闭环 | BAG IR, Schema, persistence, timeline, inspector / BAG IR、Schema、项目保存、时间轴与属性面板 |
...
1. A real developer is willing to author a combat action with a BAG-based product.  
   真实开发者愿意使用基于 BAG 的产品完成一个战斗动作。
...
Official domain products created on this foundation use independent names and the fixed signature **A BAIGE Project**. BAG itself is the platform brand and does not use that signature.

基于该底座发布的官方领域产品拥有独立名称，并统一署名 **A BAIGE Project**；BAG 自身是平台母品牌，不使用该署名。
