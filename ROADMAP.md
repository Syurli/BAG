# CrossLoom One-year Roadmap / 一年开发路线图
...
| M1 | 2–3 | Data Loop / 数据闭环 | IR, Schema, persistence, timeline, inspector / IR、Schema、项目保存、时间轴与属性面板 |
...
1. A real developer is willing to author a combat action with CrossLoom.  
   真实开发者愿意使用 CrossLoom 完成一个战斗动作。
